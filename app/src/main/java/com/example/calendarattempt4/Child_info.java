...
public class Child_info extends AppCompatActivity {
    ...
    public void makeChild_button(View view) throws SQLException {
        ...
        if(name.getText().toString().isEmpty()){
            ...
            if (MainActivity.C.create(name.getText().toString(), Integer.parseInt(age.getText().toString()), Integer.parseInt(height.getText().toString()), Integer.parseInt(weight.getText().toString())) == false){
